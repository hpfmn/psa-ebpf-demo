...
# member-ref: 4
psabpf-ctl action-selector add-member pipe "$PIPELINE" DemoIngress_as action id 2 \
...
# group-ref: 1
psabpf-ctl action-selector create-group pipe "$PIPELINE" DemoIngress_as
psabpf-ctl action-selector add-to-group pipe "$PIPELINE" DemoIngress_as 4 to 1
psabpf-ctl action-selector add-to-group pipe "$PIPELINE" DemoIngress_as 5 to 1

# ----------------------- Virtual IP actions for Action Selector ------------------------
# See comment for earlier section
# member-ref: 6
psabpf-ctl action-selector add-member pipe "$PIPELINE" DemoIngress_as action id 3 \
